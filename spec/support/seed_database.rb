...
mercenary, a thug, or simply an adventurer. Adventures: Most fighters see adven- tures, raids, and dangerous missions as
...
combat and adventure.")
  Fabricate(:dd_class, name: "Wizard", description: "A few unintelligible words and fleeting gestures carry more power than a battleaxe, when they are the words and gestures of a wizard. These simple acts make magic seem easy, but they only hint at the time the wizard must spend poring over her spellbook preparing each spell for casting, and the years before that spent in appren- ticeship to learn the arts of magic.
